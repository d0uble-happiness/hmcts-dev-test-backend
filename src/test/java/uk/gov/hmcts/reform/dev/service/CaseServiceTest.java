...
public class CaseServiceTest {
    ...
    void shouldThrowExceptionWhenCaseNotFound() {
        ...
        // When & Then
        assertThatThrownBy(() -> caseService.getCaseById("999"))
                .isInstanceOf(CaseNotFoundException.class)
                .hasMessage("Case with ID 999 not found");

        verify(caseRepository, times(1)).findById(999);
    }

    @Test
    void shouldThrowExceptionWhenInvalidCaseIdFormat() {
        // When & Then
        assertThatThrownBy(() -> caseService.getCaseById("invalid"))
                .isInstanceOf(CaseNotFoundException.class)
                .hasMessage("Invalid case ID format: invalid");

        // Repository should not be called for invalid format
    ...
    void shouldReturnNullWhenUpdatingNonExistentCase() {
        ...
        // When & Then
        assertThatThrownBy(() -> caseService.updateCase(updatedCaseData, "999"))
                .isInstanceOf(CaseNotFoundException.class)
